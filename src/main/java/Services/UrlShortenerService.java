...
public class UrlShortenerService {
    ...
    // already entered in our system
     String domain; // Use this attribute to generate urls for a custom
    ...
    private static UrlShortenerService instancia;
...
//            instancia = new UrlShortenerService(5, "www.tinyurl.com/");
    ...
    UrlShortenerService(int length, String newDomain) {
        this();
